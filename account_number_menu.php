...
'#eeeeee'); // Switch the background
 ...
 echo "<tr bgcolor='$bg' class='row'>";  ?>
	<td><?php echo"<a href='menu.php?hmmmmmmmmmmmmmm=hmmmmmmmmmm&bank={$_GET['bank']}&account=$account&accountn=$accountn&fowl eating = making sense '>". $you['account_name']."</a>"; ?></td>
	<td><?php echo $you['account_number']; ?></td>
	<td><?php echo "<a href='menu.php?hmmmmmmmmmmmmmm=hmmmmmmmmmm&bank={$_GET['bank']}&account=$account&accountn=$accountn&fowl eating = making sense '>GO TO MENU</a>";?></td>        
    <?php }?>
	</tr>
