...
if(isset($_POST['enter'])){
	...
	$query="INSERT INTO `bank_charges` (`bank`,`date`,`amount`,`accout_number_to_add`,`account_name`,`entry_date`,`narration`,`key`) VALUES ('$bank','$date','$amount','$acctno','$acctname',NOW(),'$narration','$key')";
...
<td>Narration</td>
<td><textarea  name="narration" class="smallInput" /></textarea></td>
</tr>
<tr>
<td>&nbsp;</td>
