...
if(isset($_POST['enter'])){
	...
	$query="INSERT INTO `add_effect` (`bank`,`date`, `towhompaid`, `amount`,`accout_number_to_add`,`account_name`,`entry_date`) VALUES ('$bank','$date', '$beneficiary_name', '$amount','$acctno','$acctname',NOW())";
