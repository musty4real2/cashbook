...
<td><input name="beneficiaryname" type="text" id="textfield6" class="smallInput" value="<?php if(isset($_POST['beneficiaryname'])){ echo $_POST['beneficiaryname'];} ?>" />
</td>
</tr>
...
<td>Head:</td>
<td><input name="head" type="text" id="textfield6" class="smallInput" value="<?php if(isset($_POST['head'])){ echo $_POST['head'];} ?>" />
</td></tr>

<tr>
<td>Sub-head</td>
<td><input name="subhead" type="text" id="textfield6" class="smallInput" value="<?php if(isset($_POST['subhead'])){ echo $_POST['subhead'];} ?>" />
</td>
